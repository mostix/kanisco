...
$query_course = "SELECT `courses`.`course_image`,`courses_descriptions`.`cd_name`,
    ...
    <div class="blog-item m-bot-25">
      <div class="content-container-white">
        ...
        <div class="contant-container-caption">
          <a class="a-invert" href="javascript:;"><?= $languages[$current_lang]['header_courses_program']; ?></a>
        </div>
      </div>
    ...
    <div class="sidebar-item  m-bot-25">
      ...
      <div class="content-container-white padding-l-r-15">
        <ul class="course-details">
          <li>
            <a href="#cd_program" data-caption="<?= $languages[$current_lang]['header_courses_program']; ?>">
              <span class="port-cat-icon"></span><?= $languages[$current_lang]['header_courses_program']; ?>
            </a>
          </li>
          <li>
