<?php
  ...
  if(isset($_GET['training_id'])) {
    $current_training_id = $_GET['training_id'];
    
    include_once 'training-details.php';
  }
  else {
  ...
  <main>
    <div class="inside_container">
      <section id="breadcrumbs">
        ...
        <span>&raquo;</span>
        <?=$languages[$current_lang]['menu_trainings'];?>
      </section>
      
      <h1 id="pagetitle"><?=$languages[$current_lang]['header_trainings'];?></h1>
      
      <section class="options margin_bottom">
        <a class="pageoptions" href="training-add-new.php">
          <img src="/_admin/images/newobject.gif" class="systemicon" width="16" height="16" alt="<?=$languages[$current_lang]['link_add_new_training'];?>" />
          <?=$languages[$current_lang]['link_add_new_training'];?>
        </a>
      </section>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th width="33%" class="text_left"><?=$languages[$current_lang]['header_training_name'];?></th>
            <th width="12%"><?=$languages[$current_lang]['header_training_date'];?></th>
            <th width="8%"><?=$languages[$current_lang]['header_training_start_time'];?></th>
            <th width="8%"><?=$languages[$current_lang]['header_training_end_time'];?></th>
      ...
      <div id="trainings_list" class="list_container">
<?php
        list_trainings();
?>
      </div>
