...
//  start_page_build_time_measure();
  ...
  if(isset($_GET['instructor_id'])) {
    $current_instructor_id = $_GET['instructor_id'];
    
    include_once 'instructor-details.php';
  }
  else {
    
    $page_title = $languages[$current_lang]['instructors_title'];
    $page_description = "";
  ...
  <main>
    <div class="inside_container">
      <section id="breadcrumbs">
        ...
        <span>&raquo;</span>
        <?=$languages[$current_lang]['header_instructors'];?>
      </section>
      
      <h1 id="pagetitle"><?=$page_title;?></h1>
      
      <section class="contents_options">
        <a class="pageoptions" href="/_admin/instructors/instructors-add-new.php">
          <img src="/_admin/images/newobject.gif" class="systemicon" width="16" height="16" alt="<?=$languages[$current_lang]['alt_add_new_instructor'];?>" title="<?=$languages[$current_lang]['title_add_new_language'];?>" />
          <?=$languages[$current_lang]['link_add_new_instructor'];?>
        </a>
      </section>
      ...
      <div id="instructors_list" class="list_container">
<?php
        list_instructors();
?>
      </div>
