<?php
  ...
  if(isset($_POST['submit'])) {
    ...
    if(!$is_pretty_url_unique) {
      $content_pretty_url_error = $languages[$current_lang]['content_pretty_url_error'];
  ...
  <main id="page_details">
    <div class="inside_container">
      <section id="breadcrumbs">
        ...
        <span>&raquo;</span>
        <a href="languages.php" title="<?=$languages[$current_lang]['title_breadcrumbs_languages'];?>"><?=$languages[$current_lang]['header_languages'];?></a>
        <span>&raquo;</span>
      ...
      <form id="tabs_content" method="post" action="<?=$_SERVER['PHP_SELF'];?>">
        ...
        <div>
          ...
          <a href="http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes" title="<?=$languages[$current_lang]['title_check_iso_language_codes'];?>" target="_blank">
            <img src="images/info.gif" class="systemicon" width="16" height="16" alt="<?=$languages[$current_lang]['alt_language_check_iso_codes'];?>" />
          </a>
        </div>
